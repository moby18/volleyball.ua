...
//    private $teams;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volley\FaceBundle\Entity\Team", mappedBy="playerOne")
     **/
    private $teamsOne;

    /**
     * @ORM\OneToMany(targetEntity="Volley\FaceBundle\Entity\Team", mappedBy="playerTwo")
     **/
    private $teamsTwo;
...
//            exit;
     ...
     * Set teamsOne
     *
     * @param \Volley\FaceBundle\Entity\Team $teamsOne
     * @return Player
     */
    public function setTeamsOne(\Volley\FaceBundle\Entity\Team $teamsOne = null)
    {
     ...
     * Set teamsTwo
     *
     * @param \Volley\FaceBundle\Entity\Team $teamsTwo
     * @return Player
     */
    public function setTeamsTwo(\Volley\FaceBundle\Entity\Team $teamsTwo = null)
    {
     ...
     * @return Player
     */
    public function addTeamsOne(\Volley\FaceBundle\Entity\Team $teamsOne)
    {
        $this->teamsOne[] = $teamsOne;
     ...
     * @param \Volley\FaceBundle\Entity\Team $teamsOne
     */
    public function removeTeamsOne(\Volley\FaceBundle\Entity\Team $teamsOne)
    {
     ...
     * @return Player
     */
    public function addTeamsTwo(\Volley\FaceBundle\Entity\Team $teamsTwo)
    {
        $this->teamsTwo[] = $teamsTwo;
     ...
     * @param \Volley\FaceBundle\Entity\Team $teamsTwo
     */
    public function removeTeamsTwo(\Volley\FaceBundle\Entity\Team $teamsTwo)
    {
