 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Volley\FaceBundle\Entity\TournamentRepository")
 */
class Tournament
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volley\FaceBundle\Entity\Team", mappedBy="tournament")
     */
    private $teams;

    /**
     * @ORM\OneToMany(targetEntity="Volley\FaceBundle\Entity\Round",mappedBy="tournament")
     */
    private $rounds;

    /**
     * @ORM\OneToMany(targetEntity="Volley\FaceBundle\Entity\Game",mappedBy="tournament")
     */
    private $games;
     ...
     * Add rounds
     *
     * @param \Volley\FaceBundle\Entity\Round $rounds
     * @return Tournament
     */
    public function addRound(\Volley\FaceBundle\Entity\Round $rounds)
    {
        $this->rounds[] = $rounds;
     ...
     * @param \Volley\FaceBundle\Entity\Round $rounds
     */
    public function removeRound(\Volley\FaceBundle\Entity\Round $rounds)
    {
