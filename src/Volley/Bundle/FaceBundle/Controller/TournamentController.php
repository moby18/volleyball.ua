...
use Volley\Bundle\FaceBundle\Entity\Tournament;
use Volley\Bundle\FaceBundle\Form\TournamentType;
...
class TournamentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VolleyFaceBundle:Tournament')->findAll();

        return $this->render('VolleyFaceBundle:Tournament:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('VolleyFaceBundle:Tournament:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VolleyFaceBundle:Tournament')->find($id);
        ...
        return $this->render('VolleyFaceBundle:Tournament:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('VolleyFaceBundle:Tournament:edit.html.twig', array(
            'entity'      => $entity,
