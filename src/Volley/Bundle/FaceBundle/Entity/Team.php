...
//    private $players;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volley\Bundle\FaceBundle\Entity\Player", inversedBy="teamsOne")
     * @ORM\JoinColumn(name="player_1", referencedColumnName="id")
     */
    private $playerOne;

    /**
     * @ORM\ManyToOne(targetEntity="Volley\Bundle\FaceBundle\Entity\Player", inversedBy="teamsTwo")
     ...
     * Add playerOne
     *
     * @param \Volley\Bundle\FaceBundle\Entity\Player $playerOne
     * @return Team
     */
    public function addPlayerOne(\Volley\Bundle\FaceBundle\Entity\Player $playerOne)
    {
     ...
     * @param \Volley\Bundle\FaceBundle\Entity\Player $playerOne
     */
    public function removePlayerOne(\Volley\Bundle\FaceBundle\Entity\Player $playerOne)
    {
     ...
     * Add playerTwo
     *
     * @param \Volley\Bundle\FaceBundle\Entity\Player $playerTwo
     * @return Team
     */
    public function addPlayerTwo(\Volley\Bundle\FaceBundle\Entity\Player $playerTwo)
    {
     ...
     * @param \Volley\Bundle\FaceBundle\Entity\Player $playerTwo
     */
    public function removePlayerTwo(\Volley\Bundle\FaceBundle\Entity\Player $playerTwo)
    {
     ...
     * @return Team
     */
    public function setPlayerOne(\Volley\Bundle\FaceBundle\Entity\Player $playerOne = null)
    {
        $this->playerOne = $playerOne;
     ...
     * @return Team
     */
    public function setPlayerTwo(\Volley\Bundle\FaceBundle\Entity\Player $playerTwo = null)
    {
        $this->playerTwo = $playerTwo;
