...
//            ->add('block')
            ->add('description', 'textarea', [
                'label' => 'Додаткова інформація (інша інформація у довільній формі, яка не підпала під описані вище поля, але якою важдило поділитися. Наприклад: розклад тренуваня, інформація про тренера, відомі вихованці)',
                'attr' => array(
                    'rows' => 20,
                    'class' => 'tinymce',
